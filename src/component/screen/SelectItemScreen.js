...
import ItemSelectDialog from "../part/home/ItemSelectDialog";
import aos from "aos";
...
function SelectItemScreen() {
  ...
  const StyleItemSixStack = styled(Stack)(({ theme }) => ({
    flexDirection: "row",
    alignItems: "center",
    gap: "10px",
    height: "50%",
  }));
  const StyleItemBox = styled(Box)(({ theme }) => ({
    height: "100%",
    width: "20%",
    // padding: "30px 50px",
    borderRadius: "20px",
  }));
  const StyleItemStack = styled(Stack)(({ theme }) => ({
    flexDirection: "column",
    width: "100%",
    height: "100%",
  }));
  const StyleLittleBox_60 = styled(Box)(({ theme }) => ({
    display: "flex",
  ...
  const StyleLittleBox_20 = styled(Box)(({ theme }) => ({
    display: "flex",
    justifyContent: "center",
    alignItems: "center",
    height: "18%",
